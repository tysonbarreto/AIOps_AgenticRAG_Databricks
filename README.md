# aiops_rag_databricksapp

The 'aiops_rag_databricksapp' project was generated by using the default-python template.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] aiops_rag_databricksapp_job` to your workspace.
...
3. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/aiops_rag_databricksapp.job.yml). The schedule
